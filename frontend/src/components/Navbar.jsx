    ...
    <div className="flex align-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <div className="flex items-center gap-4">
        {token ? (
          ...
          <button
            className="bg-primary text-[1rem] text-white px-8 py-3 rounded-full font-light hidden md:block"
        ...
        <div className={`${showMenu? 'fixed w-full':'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          <div className="flex items-center justify-between px-5 py-6">
            <img onClick={() => {navigate("/"); setShowMenu(false)}} className="w-36" src={assets.logo} alt="" />
